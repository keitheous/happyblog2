...
var generateGradient = function(xRGB, yRGB, steps) {
  ...
  console.log("Gradient Decrementation:", redRangeFactor,greenRangeFactor,blueRangeFactor);
  ...
  for (var i=0 ;i < steps-2 ; i++){
    ...
    decGradient.push(gradientPoint[0].toString(16).toUpperCase()+""+gradientPoint[1].toString(16).toUpperCase()+""+gradientPoint[2].toString(16).toUpperCase());
  }
  decGradient.splice(0,0,xRGB);
  decGradient.splice(decGradient.length,0,yRGB);
  console.log(decGradient);
